			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li>
					<button type="button" class="button button-rounded button-tiny"
						...
						style="margin-top: 11px; margin-left: 25px;">二维码</button>
...
<div class="jumbotron text-center">
	...
	<form class="form-inline">
		...
		<button type="button"
			class="button button-raised button-primary button-pill">搜索</button>
	</form>
</div>
...
<div id="about" class="container-fluid">
	<div class="row">
		<div class="col-sm-8">
			...
			<br> <br>
			<a href="Aboutus.jsp"><button
					class="button button-glow button-border button-rounded button-primary">加入我们团队</button></a>
		</div>
		<div class="col-sm-4">
...
<div id="project" class="container-fluid text-center">
	...
	<div class="row slideanim"
		...
		<a href="project.jsp"><button
				class="button button-glow button-border button-rounded button-primary">更多>></button></a>
	</div>
</div>
				...
				<div class="row">
					<div class="col-sm-12 form-group">
						<button class="btn btn-default pull-right" type="submit"
							onclick="disp_confirm()">提交</button>
					</div>
				</div>
			</div>
		</form>
...
<footer class="container-fluid text-center">
	...
	<p>
		发现有不足的地方，请联系作者<a
			href="http://wpa.qq.com/msgrd?v=3&uin=673724357&site=qq&menu=yes"
